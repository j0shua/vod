...
<div class="grid_12">
    <form class="normal-form" id="main-form" action="<?php echo $form_action; ?>" method="post" >
        ...
        <?php } else { ?>
            <p>
                <label for="resource_code">รหัสสื่อ</label><input type="text" id="resource_code" name="data[resource_code]" value="<?php echo $form_data['resource_code']; ?>" style="width: 465px;">
            </p>
            <p>
                <label for="unit_price">ค่าบริการ</label><?php echo form_dropdown('data[unit_price]', $unit_price_options, $form_data['unit_price'], 'id="unit_price"'); ?>
            </p>
        ...
        <p>
            ...
            <?php echo form_dropdown('data[degree_id]', $degree_id_options, $form_data['degree_id'], 'id="degree_id"'); ?>
        </p>
        <p>
