...
<div class="grid_10">
    ...
    <h2 class="head1">{title} <?php echo anchor('http://www.youtube.com/embed/eOFQvhNVrYA?rel=0&wmode=transparent&autoplay=1', "วิดีโอสอนการใช้งาน", 'class="youtube btn-a" target="_blank"'); ?></h2>
    <script>
