<h1><?php echo $title; ?> <?php echo anchor('http://www.youtube.com/embed/O1T9grAanWM?rel=0&wmode=transparent&autoplay=1', "วิดีโอสอนการเพิ่มโจทย์", 'class="youtube btn-a" target="_blank"'); ?>
    <?php echo anchor('http://www.youtube.com/embed/qFQxVU1BS0Q?rel=0&wmode=transparent&autoplay=1', "วิดีโอสอนการเพิ่มโจทย์ต่อเนื่อง", 'class="youtube btn-a" target="_blank"'); ?>
