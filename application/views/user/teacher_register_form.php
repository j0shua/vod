...
<div class="grid_6">
    <form class="normal-form" method="post" action="<?php echo $form_action; ?>" id="main-form" autocomplete="off" enctype="multipart/form-data">
        <?php if (!$make_money) { ?>
        ...
        <p>
            <label for="identity_document" >รูปถ่ายบัตรข้าราชการ/บัตรประชาชน</label>
            <input id="identity_document" type="file" name="identity_document" size="20" />

        </p>
        <p>
            <label for="educational_document" >รูปถ่ายใบรับรองวิชาชีพครู</label>

            <input id="educational_document" type="file" name="educational_document" size="20" />
        </p>
