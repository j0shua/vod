<div class="top_10">
    <div class="grid_3">
        ...
        <?php if ($taxonomy) { ?>
            <h2  class="head1" style="margin-bottom: 2px;">วิดีโอแนะนำเปิดเรียนได้ทันที</h2>
        ...
        <?php if (count($course_open['rows']) > 0) { ?>
            <h2  class="head1" style="margin-bottom: 2px;" >หลักสูตรที่เปิดสอน (สมัครเรียนได้)</h2>
            <div>
                <table class="data">
    ...
    <div class="grid_9">
        <?php if ($taxonomy_title) { ?>
            <h1  class="head1" >วิดีโอ <?php echo $taxonomy_title; ?> (เปิดดูได้ทันที)<?php echo ' <span>[' . gmdate("H:i:s", @$taxonomy_duration) . ']</span>'; ?>
                <?php
                if (isset($copy_url)) {
                    ?>
