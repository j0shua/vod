        ...
        <div class="front_box">
            ...
            if (!$is_android) {
                if ($download_browser) {
                    ?>
                    <div >
                        <a title="ดาวน์โหลดโปรแกรมเพื่อใช้งาน" target="_blank" href="http://www.google.com/intl/th/chrome/browser/" class="link-img"><img src="<?php echo base_url('files/images/chrome_download.png') ?>" alt="Download Google Chrome"></a>
                    </div>
                    <div >
            ...
            <ul>
                <li class="house_teacher">
                    ...
                    <div class="teacher_name">
                        ...
                        <?php echo anchor('house/u/2', 'ประสิทธิ์ จันต๊ะภา'); ?>
                    </div>
