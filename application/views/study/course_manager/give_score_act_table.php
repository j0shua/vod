...
<div class="grid_12">
 ...
 <?php if ($course_act_data['cmat_id'] == 2) { ?>
        ...
        <?php } ?>
        <p>
            <label for="send_time_d">วันที่ส่ง </label>
            <input type="text" id="send_time_d" name="data[send_time_d]" value="<?php echo $form_data['send_time_d']; ?>">
        </p>
        <p>
            <label for="send_time_h">เวลาที่ส่ง</label>
            <input type="text" id="send_time_h" name="data[send_time_h]" value="<?php echo $form_data['send_time_h']; ?>">
        </p>
        <p>
