...
$config['noreply_email'] = 'noreply@vod-researchproject.info'; //Email สำหรับ ส่งจากระบบ 
$config['netConnectionUrl_parent'] = 'rtmp://203.146.170.199:1936/pkv2'; //url สำหรับ falsh streamming
$config['netConnectionUrl'] = 'rtmp://' . $basename . ':1936/vod_researchproject'; //url สำหรับ falsh streamming  
...
$config['analytics'] = '';
$config['adsense'] = '';
$config['template_name'] = 'simple_3p';
$config['template_menu_view'] = 'user_menu';