...
$system_root = '/var/www/clients/client2/web14/web/v2/';
...
$config['site_name'] = 'pec9.com'; // ชื่อเว็บไซต์
...
$config['noreply_email'] = 'noreply@pec9.com'; //Email สำหรับ ส่งจากระบบ 
...
$config['upload_temp_dir'] = $system_root . 'upload_temp/'; //ที่เก็บ temp video video upload
...
$config['netConnectionUrl'] = 'rtmpe://203.146.170.199:1936/pec9'; //url สำหรับ falsh streamming
...
$config['full_encode_log_dir'] = $system_root . 'encode_log/'; //encode log folder
