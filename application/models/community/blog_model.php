...
class blog_model extends CI_Model {
    ...
    public function find_all($page, $qtype, $query, $rp, $sortname, $sortorder, $board_type_id) {
        ...
        foreach ($result->result_array() as $row) {
            ...
            if ($this->auth->is_admin()) {
                $row['delete_url'] = site_url('community/blog/delete/' . $row['p_id']);
            }
        ...
        $blog_type_data = $this->get_blog_type_data($board_type_id);
        $data['board_type_id'] = $board_type_id;
        $data['title'] = $blog_type_data['title'];
    ...
    function get_blog_type_data($board_type_id) {
